...
class VisitorAutomationService {
     ...
     */
    static getMinistryKeywords(ministryName) {
        const keywordMap = {
     ...
     */
    static isAgeGroupCompatible(ministryName, ageGroup) {
        const compatibility = {
        ...
        return compatibleMinistries.some(ministry => ministryName.toLowerCase().includes(ministry.toLowerCase()));
    }
    /**
