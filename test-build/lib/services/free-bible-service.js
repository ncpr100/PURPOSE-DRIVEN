...
exports.FREE_BIBLE_VERSIONS = exports.freeBibleService = void 0;
class FreeBibleService {
    ...
    async getVerse(reference, version = 'RVR1960') {
        try {
    ...
    async getVerseFromGetBible(reference, version) {
        try {
            ...
            if (response.ok) {
                ...
                const verse = Object.values(data.book[bookKey].chapter[chapterKey].verse)[0];
                return {
    ...
    async searchVerses(query, version = 'RVR1960', limit = 20) {
        try {
    ...
    async fallbackSearch(query, version, limit) {
    ...
    async compareVerses(reference, versions) {
        const results = [];
    ...
    async getVerseWithFallback(reference, version) {
    ...
    async getVerseFromBibleGateway(reference, version) {
        try {
    ...
    async getCrossReferences(reference, topic) {
    ...
    async getRandomVerse(version = 'RVR1960') {
        const popularVerses = [
     ...
     */
    async getVerseFromBibleAPICom(reference, version = 'WEB') {
        try {
     ...
     */
    async getVerseFromBibleOrgLabs(reference, version = 'NET') {
        try {
     ...
     */
    async getVerseEnhanced(reference, version = 'RVR1960') {
        try {
...
exports.freeBibleService = new FreeBibleService();
// Export available versions for UI components
exports.FREE_BIBLE_VERSIONS = [
...
//# sourceMappingURL=free-bible-service.js.map