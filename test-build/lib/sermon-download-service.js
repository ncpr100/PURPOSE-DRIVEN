...
exports.sermonDownloadService = void 0;
const jspdf_1 = require("jspdf");
class SermonDownloadService {
    /**
     * Download sermon in specified format
     */
    async downloadSermon(sermon, format) {
        try {
            switch (format) {
                case 'pdf':
     ...
     */
    generateHTML(sermon, forWord = false) {
...
exports.sermonDownloadService = new SermonDownloadService();
exports.default = exports.sermonDownloadService;
//# sourceMappingURL=sermon-download-service.js.map