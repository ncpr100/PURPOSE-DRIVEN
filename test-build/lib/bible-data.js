...
exports.getVerseTranslations = exports.getAvailableVerses = exports.findBestMatch = exports.normalizeReference = exports.ENHANCED_BIBLE_DATA = void 0;
// Enhanced Bible data with authentic translations
exports.ENHANCED_BIBLE_DATA = {
    'Juan 3:16': {
        // ESPAÑOL
...
function findBestMatch(input) {
    ...
    for (const key of Object.keys(exports.ENHANCED_BIBLE_DATA)) {
...
function getAvailableVerses() {
    return Object.keys(exports.ENHANCED_BIBLE_DATA);
}
exports.getAvailableVerses = getAvailableVerses;
function getVerseTranslations(reference) {
    const bestMatch = findBestMatch(reference);
    return bestMatch ? exports.ENHANCED_BIBLE_DATA[bestMatch] : null;
}
exports.getVerseTranslations = getVerseTranslations;
