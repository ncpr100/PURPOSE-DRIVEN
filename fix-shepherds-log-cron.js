const fs = require('fs');
const filePath = 'app/api/cron/shepherds-log/route.ts';
const newCode = `// app/api/cron/shepherds-log/route.ts
...
console.log('? Cron actualizado para actualizar agent_settings');
