...
export function RealTimeToast({
  ...
  return (
    <div
      className={`fixed ${getPositionClasses()} z-[100] space-y-2 max-w-sm w-full pointer-events-none`}
    >
      {/* Clear all button */}
                    ...
                    {toast.data.category && (
                      <div className="mt-2">
                        <Badge variant="outline" className="text-xs">
                          {toast.data.category === "events"
                            ? "Eventos"
                            : toast.data.category === "donations"
                              ? "Donaciones"
                              : toast.data.category === "communications"
                                ? "Comunicaciones"
                                : toast.data.category === "systemUpdates"
                                  ? "Sistema"
                                  : toast.data.category}
                        </Badge>
                      </div>
