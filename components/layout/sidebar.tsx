...
const navigationItems = [
  {
    ...
    roles: ['ADMIN_IGLESIA', 'CHURCH_ADMIN', 'PASTOR', 'LIDER', 'MIEMBRO'],
  },
  {
    title: 'Miembros',
    href: '/members',
    icon: Users,
    roles: ['SUPER_ADMIN', 'ADMIN_IGLESIA', 'CHURCH_ADMIN', 'PASTOR', 'LIDER'],
  },
  {
    title: 'Voluntarios',
    href: '/volunteers',
  ...
  },
  {
    ...
    href: '/sermons',
    icon: BookOpen,
    roles: ['SUPER_ADMIN', 'ADMIN_IGLESIA', 'CHURCH_ADMIN', 'PASTOR'],
  },
  {
  ...
  },
  {
    ...
    href: '/profile',
    icon: Settings,
    roles: ['SUPER_ADMIN', 'ADMIN_IGLESIA', 'CHURCH_ADMIN', 'PASTOR', 'LIDER', 'MIEMBRO'],
  },
  {
