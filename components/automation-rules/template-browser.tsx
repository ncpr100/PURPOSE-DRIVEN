  ...
  const handleActivateFromModal = async (templateId: string, customizations: any) => {
    try {
      ...
      toast({
        ...
        description: 'La regla de automatizaciÃƒÂ³n estÃƒÂ¡ ahora activa',
      });
    } catch (error) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Plantillas de AutomatizaciÃƒÂ³n</h2>
      ...
      <Tabs value={selectedCategory} onValueChange={setSelectedCategory}>
        <TabsList className="grid w-full grid-cols-3 lg:w-auto lg:grid-cols-5">
          ...
          <TabsTrigger value="PRAYER_REQUEST">
            OraciÃƒÂ³n ({templates.filter(t => t.category === 'PRAYER_REQUEST').length})
          </TabsTrigger>
