...
const DEFAULT_ENTRIES: ShepherdEntry[] = [
  {
    ...
    initials: "JM",
    name: "José Martínez",
    reason: "Sin asistir 23 días · riesgo CRÍTICO",
    urgency: "CRITICAL",
    phone: "+573001234567",
  },
  {
    ...
    initials: "PG",
    name: "Patricia G.",
    reason: "Primera ofrenda — momento espiritual",
    urgency: "EMERALD",
    phone: "+573009876543",
  },
  {
    ...
    initials: "RT",
    name: "Rafael T.",
    reason: "Pipeline liderazgo · score 84/100",
    urgency: "GOLD",
    phone: "+573001112222",
  },
  {
    ...
    initials: "CV",
    name: "Carmen V.",
    reason: "Voluntaria 11 sem. consecutivas",
    urgency: "HIGH",
    phone: "+573003334444",
  },
];
...
export function ShepherdsLogCosmos({
  ...
  return (
    <div>
      ...
      {localEntries.length === 0 ? (
        ...
        >
          <CheckCircle size={14} style={{ color: "#1DC98C" }} /> Todas las
          ovejas cuidadas esta semana
        </div>
      ) : (
              ...
              <a
                ...
                onMouseEnter={(e) => {
                  ...
                  (e.currentTarget as HTMLAnchorElement).style.background =
                    "rgba(29,201,140,0.12)";
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLAnchorElement).style.borderColor =
                    "rgba(29,201,140,0.2)";
                  (e.currentTarget as HTMLAnchorElement).style.background =
                    "rgba(29,201,140,0.05)";
                }}
              >
      ...
      <div
        style={{
          fontSize: "8px",
          color: "rgba(138,147,168,0.4)",
          textAlign: "center",
          marginTop: "6px",
          lineHeight: 1.5,
        }}
      >
        Generado por IA como apoyo ministerial.
        <br />
