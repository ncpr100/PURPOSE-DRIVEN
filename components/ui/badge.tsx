...
// COSMOS REDESIGN — fixes P1-A: success/warning were hardcoded bg-green-500/bg-yellow-500
...
const badgeVariants = cva(
  ...
  ].join(" "),
  {
    variants: {
      variant: {
        // ─ Core shadcn/ui variants (token-based) ─
        default:
        ...
        // ─ Semantic status variants (FIXED P1-A) ─
        success:
        ...
        // ─ Follow-up status variants (replaces STATUS_COLORS map in visitor-followups-client.tsx P1-C) ─
        pending:
        ...
        // ─ Priority variants (replaces PRIORITY_COLORS map P1-C) ─
        "priority-high":
        ...
        // ─ Lifecycle stage variants (for member badges) ─
        visitante:
        ...
        // ─ Coverage status variants (Agent 12) ─
        confirmed:
          "bg-[rgba(29,201,140,0.12)] text-[#1DC98C] border-[rgba(29,201,140,0.25)]",
        covered:
