...
export function EnhancedSpiritualAssessment({
  ...
  const validateAssessment = (): { valid: boolean; message?: string } => {
    ...
    if (ministryPassions.length === 0) {
      return {
        valid: false,
        message: "Por favor selecciona al menos una pasiÃƒÆ’Ã‚Â³n ministerial",
      };
    }
    ...
    if (!motivation.trim()) {
      return {
        valid: false,
        message: "Por favor describe tu motivaciÃƒÆ’Ã‚Â³n para servir",
      };
    }
    ...
    try {
      ...
      setSaveError(
        error instanceof Error
          ? error.message
          : "Error al guardar la evaluaciÃƒÆ’Ã‚Â³n",
      );
    } finally {
      setIsSaving(false);
    }
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h2 className="text-3xl font-bold">
                EvaluaciÃƒÆ’Ã‚Â³n de Dones Espirituales
              </h2>
            ...
            <div className="mt-4 p-4 bg-[hsl(var(--success)/0.10)] dark:bg-[hsl(var(--success))] border border-[hsl(var(--success)/0.3)] dark:border-[hsl(var(--success)/0.30)] rounded-lg flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-foreground dark:text-[hsl(var(--success)/0.6)]">
                  Ãƒâ€šÃ‚Â¡EvaluaciÃƒÆ’Ã‚Â³n Guardada!
                </p>
                <p className="text-sm text-[hsl(var(--success))] dark:text-[hsl(var(--success)/0.8)] mt-1">
                  Tu evaluaciÃƒÆ’Ã‚Â³n de dones espirituales se ha guardado
                  correctamente.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                ...
                seleccionar mÃƒÆ’Ã‚Âºltiples dones en diferentes categorÃƒÆ’Ã‚Â­as.
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Ãƒâ€šÃ‚Â¿QuÃƒÆ’Ã‚Â© ÃƒÆ’Ã‚Â¡reas del ministerio te apasionan? Selecciona todas las que
                apliquen.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Ãƒâ€šÃ‚Â¿CuÃƒÆ’Ã‚Â¡nta experiencia tienes sirviendo en ministerios cristianos?
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Select
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Describe brevemente lo que sientes que Dios te estÃƒÆ’Ã‚Â¡ llamando a
                hacer. Esto puede ser general o especÃƒÆ’Ã‚Â­fico.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Textarea
                ...
                disabled={readOnly}
                placeholder="Ej: Siento un llamado a trabajar con jÃƒÆ’Ã‚Â³venes, enseÃƒÆ’Ã‚Â±ar la Palabra, servir a los necesitados..."
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                MotivaciÃƒÆ’Ã‚Â³n para Servir
                <span className="text-[hsl(var(--destructive))]">*</span>
              </CardTitle>
              <CardDescription>
                Ãƒâ€šÃ‚Â¿QuÃƒÆ’Ã‚Â© te motiva a servir en la iglesia? Ãƒâ€šÃ‚Â¿QuÃƒÆ’Ã‚Â© esperas lograr o
                aprender?
              </CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <div className="p-4 bg-[hsl(var(--info)/0.10)] dark:bg-[hsl(var(--info))] border border-[hsl(var(--info)/0.3)] dark:border-blue-800 rounded-lg flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-foreground dark:text-[hsl(var(--info)/0.6)]">
                  Completa al menos el 60% de la evaluaciÃƒÆ’Ã‚Â³n para poder
