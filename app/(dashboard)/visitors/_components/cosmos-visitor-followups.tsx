...
// Full Cosmos redesign — FIXES P1-C: replaces local STATUS_COLORS + PRIORITY_COLORS maps
...
// TYPE LABELS (Spanish — compliant with original)
...
// ─── STATUS → Badge variant (replaces STATUS_COLORS map P1-C FIX) ─
...
// ─── PRIORITY → Badge variant (replaces PRIORITY_COLORS map P1-C FIX) ─
...
const MOCK_FOLLOWUPS = [
  { id: "1", name: "Juan García",      email: "juan@email.com",   phone: "+573001234567", type: "first_time",  status: "pending",   priority: "high",   scheduledAt: "Hoy 10:00 AM", notes: "Primera visita — llegó con un amigo", isFirstTime: true },
  ...
  { id: "4", name: "Luisa Pérez",      email: "luisa@email.com",  phone: "+573002223333", type: "visit",       status: "completed", priority: "medium", scheduledAt: "Ayer",          notes: "Visitada — interesada en grupos pequeños", isFirstTime: false },
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap mb-1">
                    ...
                    {/* Status badge (P1-C FIX — uses variant system) */}
                    ...
                    {/* Priority badge (P1-C FIX — uses variant system) */}
