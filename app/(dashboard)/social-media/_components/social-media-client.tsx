  ...
  const syncAnalytics = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.success('AnalÃƒÂ­ticas sincronizadas exitosamente')
      } else {
        throw new Error('Analytics sync failed')
      }
    } catch (error) {
      console.error('Failed to sync analytics:', error)
      toast.error('Error al sincronizar analÃƒÂ­ticas')
    } finally {
    ...
    return (
      <Card>
        <CardContent className="flex items-center justify-center py-8">
          <p>Por favor inicia sesiÃƒÂ³n para acceder a la gestiÃƒÂ³n de redes sociales.</p>
        </CardContent>
      </Card>
    )
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">GestiÃƒÂ³n profesional simplificada</p>
        </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <Textarea
                  id="content"
                  placeholder="Escribe tu mensaje inspiracional aquÃƒÂ­..."
              ...
              {/* Scheduling */}
              <div className="space-y-3">
                <Label className="text-base font-medium">Programar PublicaciÃƒÂ³n (Opcional)</Label>
                ...
                <div className="flex items-center justify-between p-4 bg-[hsl(var(--lavender)/0.10)] rounded-lg border border-[hsl(var(--lavender)/0.3)]">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[hsl(var(--lavender))]">Optimizar contenido automÃƒÂ¡ticamente</p>
                    </div>
                  </div>
                  <Switch
        ...
        <TabsContent value="analytics" className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold">AnalÃƒÂ­ticas Unificadas</h2>
              <p className="text-muted-foreground">MÃƒÂ©tricas de todas tus plataformas en un lugar</p>
            </div>
            ...
            <CardContent>
              {aiAddonActive ? (
                <div className="space-y-6">
                  <div className="p-6 bg-[hsl(var(--lavender)/0.10)] rounded-lg border border-[hsl(var(--lavender)/0.3)]">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">GeneraciÃƒÂ³n de contenido con GPT-4</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle2 className="h-4 w-4 text-[hsl(var(--success))]" />
                        <span className="text-sm">OptimizaciÃƒÂ³n automÃƒÂ¡tica</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle2 className="h-4 w-4 text-[hsl(var(--success))]" />
                        <span className="text-sm">AnÃƒÂ¡lisis de engagement</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle2 className="h-4 w-4 text-[hsl(var(--success))]" />
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-lg">EstadÃƒÂ­sticas de Uso</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      ...
                      <p className="text-xs text-muted-foreground">40% del lÃƒÂ­mite mensual utilizado</p>
                    </CardContent>
                  </Card>
                </div>
              ) : (
                <div className="text-center space-y-6">
                  ...
                  <div className="grid gap-3 max-w-sm mx-auto text-left">
                    ...
                    <div className="flex items-center gap-3">
                      <CheckCircle2 className="h-5 w-5 text-[hsl(var(--success))] flex-shrink-0" />
                      <span className="text-sm">OptimizaciÃƒÂ³n automÃƒÂ¡tica por plataforma</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle2 className="h-5 w-5 text-[hsl(var(--success))] flex-shrink-0" />
                      <span className="text-sm">AnÃƒÂ¡lisis predictivo de engagement</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle2 className="h-5 w-5 text-[hsl(var(--success))] flex-shrink-0" />
                      <span className="text-sm">ProgramaciÃƒÂ³n inteligente</span>
                    </div>
                  </div>
