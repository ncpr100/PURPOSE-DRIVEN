...
export default function SocialMediaDashboardClient({
  ...
  const syncAnalytics = async () => {
    ...
    try {
      ...
      if (response.ok) {
        toast.success('AnalÃƒÂ­ticas sincronizadas')
        await loadAnalytics()
      } else {
        toast.error('Error sincronizando analÃƒÂ­ticas')
      }
    } catch (error) {
      toast.error('Error de conexiÃƒÂ³n')
    } finally {
    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">ÃƒÅ¡ltimos 30 dÃƒÂ­as</p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Tasa de InteracciÃƒÂ³n</CardTitle>
                    ...
                    <div key={account.id} className="flex items-center space-x-4 p-4 border rounded-lg">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-muted-foreground">
                          {account.platform} Ã¢â‚¬Â¢ @{account.username}
                        </p>
          ...
          {recentPosts.length > 0 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Tus publicaciones mÃƒÂ¡s recientes
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-2 border-dashed border-border">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  Conecta MÃƒÂ¡s Plataformas
                </CardTitle>
                <CardDescription>
                  AmplÃƒÂ­a tu alcance conectando mÃƒÂ¡s redes sociales
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {unconnectedPlatforms.map(platform => (
                    ...
                    >
                      ...
                      <span className="text-xs text-muted-foreground text-center">
                        {platform === 'FACEBOOK' && 'PÃƒÂ¡ginas y posts automÃƒÂ¡ticos'}
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="content"
                  placeholder="Ã‚Â¿QuÃƒÂ© quieres compartir con tu comunidad?"
              ...
              <div className="space-y-3">
                <Label>Plataformas de PublicaciÃƒÂ³n</Label>
              ...
              {/* Schedule */}
              <div className="space-y-2">
                <Label htmlFor="schedule">Programar PublicaciÃƒÂ³n (Opcional)</Label>
                <Input
                  id="schedule"
                  type="datetime-local"
        ...
        <TabsContent value="analytics" className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-semibold">AnalÃƒÂ­ticas de Redes Sociales</h2>
              <p className="text-muted-foreground">MÃƒÂ©tricas de rendimiento de todas tus plataformas</p>
            </div>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      ...
                      Posts con Mayor InteracciÃƒÂ³n
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
            ...
            <Card>
              <CardContent className="flex items-center justify-center py-12">
                <div className="text-center">
                  ...
                  <h3 className="font-medium text-foreground mb-2">No hay datos de analÃƒÂ­ticas</h3>
                  <p className="text-muted-foreground mb-4">
                    Conecta tus plataformas y publica contenido para ver analÃƒÂ­ticas
                  </p>
                  <Button onClick={syncAnalytics} variant="outline">
                    <RefreshCw className="h-4 w-4 mr-2" />
                    Sincronizar AnalÃƒÂ­ticas
                  </Button>
                </div>
              </CardContent>
            </Card>
        ...
        <TabsContent value="accounts" className="space-y-6">
          <div>
            <h2 className="text-2xl font-semibold">GestiÃƒÂ³n de Cuentas</h2>
              ...
              {aiAddonActive ? (
                <div className="space-y-3">
                  <div className="flex items-center gap-2 text-sm text-[hsl(var(--success))]">
                    ...
                    GeneraciÃƒÂ³n automÃƒÂ¡tica de hashtags
                  </div>
                  <div className="flex items-center gap-2 text-sm text-[hsl(var(--success))]">
                    <CheckCircle2 className="h-4 w-4" />
                    OptimizaciÃƒÂ³n de contenido por plataforma
                  </div>
                  <div className="flex items-center gap-2 text-sm text-[hsl(var(--success))]">
                    <CheckCircle2 className="h-4 w-4" />
                  ...
                  <div className="flex items-center gap-2 text-sm text-[hsl(var(--success))]">
                    <CheckCircle2 className="h-4 w-4" />
                    AnÃƒÂ¡lisis de audiencia y tendencias
                  </div>
                </div>
              ) : (
                <div className="space-y-4">
                    ...
                    <div key={account.id} className="flex items-center justify-between p-4 border rounded-lg">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">{account.platform} Ã¢â‚¬Â¢ @{account.username}</p>
                          <div className="flex items-center gap-2 mt-1">
          ...
          {unconnectedPlatforms.length > 0 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Conecta mÃƒÂ¡s plataformas para ampliar tu alcance
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
