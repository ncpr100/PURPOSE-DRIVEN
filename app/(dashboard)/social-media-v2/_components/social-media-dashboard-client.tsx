                    ...
                    <div key={account.id} className="flex items-center space-x-4 p-4 border rounded-lg">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-muted-foreground">
                          {account.platform} Ò¢âa¬¢ @{account.username}
                        </p>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="content"
                  placeholder="ÒaQuÒ© quieres compartir con tu comunidad?"
                    ...
                    <div key={account.id} className="flex items-center justify-between p-4 border rounded-lg">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">{account.platform} Ò¢âa¬¢ @{account.username}</p>
                          <div className="flex items-center gap-2 mt-1">
