      ...
      <DialogContent className="sm:max-w-[500px]" onInteractOutside={(e) => !canClose && e.preventDefault()}>
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <Lock className="h-5 w-5 text-[hsl(var(--info))]" />
            {isFirstLogin ? '¡Cambio de Contraseña Requerido!' : 'Cambiar Contraseña'}
          </DialogTitle>
          <DialogDescription>
            {isFirstLogin ? (
              <div className="flex items-start gap-2 mt-2 p-3 bg-[hsl(var(--warning)/0.10)] border border-[hsl(var(--warning)/0.3)] rounded-md">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                disabled={isLoading}
                className={errors.currentPassword ? 'border-[hsl(var(--destructive))]' : ''}
              />
              <button
                type="button"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                disabled={isLoading}
                className={errors.newPassword ? 'border-[hsl(var(--destructive))]' : ''}
              />
              <button
                type="button"
