        ...
        <CardContent className="flex items-center justify-between py-4 px-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium">
                ¿Quieres personalizar colores, fuentes y diseño visual?
              </p>
              <p className="text-xs text-muted-foreground">
                Todo eso está en Tema y Marca — incluyendo los datos de tu
                iglesia
              </p>
            </div>
          </div>
          <Link href="/settings/theme">
            <Button
              variant="outline"
              size="sm"
              className="border-[hsl(var(--brand-gold)/0.4)] shrink-0"
            >
              Ir a Tema y Marca
            </Button>
          </Link>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Seleccionar el país activa los métodos de pago disponibles en
                  tu región.
                </p>
              </div>
              <div>
