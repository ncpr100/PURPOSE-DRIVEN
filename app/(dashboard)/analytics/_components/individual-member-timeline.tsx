      ...
      const mockMembers: MemberProfile[] = [
        {
          ...
          engagementScore: 85,
          spiritualMaturity: 78,
          lastActivity: '2024-11-10',
          nextMilestone: 'Completar curso de liderazgo',
          riskLevel: 'low',
          ministries: ['Enseñanza', 'Hospitalidad'],
          spiritualGifts: ['ENSEÑANZA', 'HOSPITALIDAD', 'MISERICORDIA'],
          timeline: [
            {
              id: '1',
              type: 'milestone',
              title: 'Completó Bautismo',
              description: 'Ana completó su bautismo en la ceremonia del domingo',
              date: '2024-11-08',
              category: 'spiritual',
              impact: 'positive',
              score: 95
            },
            {
              id: '2',
              type: 'activity',
              title: 'Participó en Retiro Espiritual',
              description: 'Asistió al retiro espiritual de fin de semana',
              date: '2024-10-25',
              category: 'spiritual',
              impact: 'positive',
              score: 88,
              metadata: {
                eventId: 'retreat-2024'
              }
            },
            {
              id: '3',
              ...
              description: 'Completó la evaluación de dones espirituales',
              date: '2024-10-15',
              category: 'personal',
              impact: 'positive',
              metadata: {
            ...
            },
            {
              id: '4',
              type: 'growth',
              title: 'Aumento en Compromiso',
              description: 'Su puntuación de compromiso aumentó significativamente',
              date: '2024-10-01',
              category: 'engagement',
              impact: 'positive',
              score: 85,
            ...
            },
            {
              id: '5',
              type: 'activity',
              title: 'Se Unió al Ministerio de Enseñanza',
              description: 'Comenzó a servir como asistente de enseñanza',
              date: '2024-09-20',
              category: 'service',
              impact: 'positive',
              metadata: {
                ministryId: 'teaching-ministry'
              }
            }
          ]
        },
        {
          ...
          engagementScore: 65,
          spiritualMaturity: 55,
          lastActivity: '2024-11-05',
          nextMilestone: 'Completar clase de membresía',
          riskLevel: 'medium',
          ministries: ['Hospitalidad'],
          spiritualGifts: ['AYUDA', 'HOSPITALIDAD'],
          timeline: [
            {
              id: '6',
              type: 'alert',
              title: 'Disminución en Asistencia',
              description: 'Ha faltado a 3 servicios consecutivos',
              date: '2024-11-01',
              category: 'engagement',
              impact: 'negative',
              score: 65,
            ...
            },
            {
              id: '7',
              type: 'activity',
              title: 'Primera Vez Voluntario',
              description: 'Participó como voluntario en evento comunitario',
              date: '2024-10-12',
              category: 'service',
              impact: 'positive'
            }
