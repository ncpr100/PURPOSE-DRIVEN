    ...
    <div className="container mx-auto p-3 md:p-6">
      <div className="mb-6 md:mb-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 mb-2">
          <div className="btn-cta-gradient p-2 rounded-lg flex-shrink-0">
        ...
        <div className="btn-cta-gradient border border-[hsl(var(--info)/0.3)] rounded-lg p-3 md:p-4 mt-4">
          <div className="flex items-start gap-3">
            <svg className="h-5 w-5 text-[hsl(var(--info))] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <div>
              <h3 className="font-semibold text-foreground text-sm md:text-base">Platform Marketing Tools</h3>
              <p className="text-xs md:text-sm text-[hsl(var(--info))] mt-1">
