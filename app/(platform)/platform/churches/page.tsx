    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button asChild className="bg-[hsl(var(--info))] hover:bg-[hsl(var(--info))]">
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-lg btn-cta-gradient flex items-center justify-center text-white font-bold text-xl">
                      {church.name.charAt(0)}
                    </div>
                    
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <h3 className="text-lg font-semibold text-foreground">{church.name}</h3>
                        {church.isActive ? (
                    ...
                    <div className="grid grid-cols-2 gap-4 text-center">
                      <div className="bg-[hsl(var(--info)/0.10)] p-3 rounded-lg">
                        <div className="flex items-center justify-center gap-1 mb-1">
                          ...
                          <span className="text-lg font-bold text-[hsl(var(--info))]">
                            {church.stats.activeUsers}
                          </span>
                        </div>
                        <p className="text-xs text-[hsl(var(--info))]">Usuarios</p>
                      </div>
                      ...
                      <div className="bg-[hsl(var(--success)/0.10)] p-3 rounded-lg">
                        ...
                        <p className="text-xs text-[hsl(var(--success))]">Miembros</p>
                      </div>
                      
                      <div className="bg-[hsl(var(--lavender)/0.10)] p-3 rounded-lg">
                        <div className="flex items-center justify-center gap-1 mb-1">
                          <Calendar className="h-4 w-4 text-[hsl(var(--lavender))]" />
                          <span className="text-lg font-bold text-[hsl(var(--lavender))]">
                            {church.stats.totalEvents}
                          </span>
                        </div>
                        <p className="text-xs text-[hsl(var(--lavender))]">Eventos</p>
                      </div>
                      ...
                      <div className="bg-[hsl(var(--warning)/0.10)] p-3 rounded-lg">
                        ...
                        <p className="text-xs text-[hsl(var(--warning))]">Donaciones</p>
                      </div>
                    </div>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem 
                          ...
                          className="flex items-center w-full text-[hsl(var(--destructive))] hover:text-[hsl(var(--destructive))] hover:bg-[hsl(var(--destructive)/0.10)]"
                        >
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              className="bg-[hsl(var(--destructive))] hover:bg-[hsl(var(--destructive))]"
            >
              {deleteLoading ? (
                <>
