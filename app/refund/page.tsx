  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 space-y-10 text-gray-700 text-sm leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-4">2. Subscription Cancellations</h2>
          ...
          <ul className="list-disc pl-6 space-y-1 mb-3">
            ...
            <li>Contacting our support team at <a href="mailto:soporte@khesed-tek-systems.org" className="text-blue-600 underline">soporte@khesed-tek-systems.org</a></li>
          </ul>
          ...
          <div className="overflow-x-auto mb-3">
            <table className="w-full border border-gray-200 text-sm">
              <thead className="bg-gray-50">
                <tr>
                  <th className="border border-gray-200 px-4 py-2 text-left font-semibold text-gray-800 w-48">Situation</th>
                  <th className="border border-gray-200 px-4 py-2 text-left font-semibold text-gray-800">Refund</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={situation} className="even:bg-gray-50">
                    <td className="border border-gray-200 px-4 py-2 font-medium text-gray-800 align-top">{situation}</td>
                    <td className="border border-gray-200 px-4 py-2">{refund}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1 mb-3">
            <li>Email: <a href="mailto:legal@khesed-tek-systems.org" className="text-blue-600 underline">legal@khesed-tek-systems.org</a></li>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-4">5. Annual Subscriptions</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-4">6. Failed Payments</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-4">7. Termination by Khesed-Tek</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-4">8. Disputes</h2>
          <p>If you believe a charge was made in error and we are unable to resolve the matter directly, you may file a dispute with your payment provider. We encourage you to contact us first at <a href="mailto:legal@khesed-tek-systems.org" className="text-blue-600 underline">legal@khesed-tek-systems.org</a> as we are committed to resolving issues fairly and promptly.</p>
        </section>
        ...
        <section>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 space-y-2">
            ...
            <p>Billing Support: <a href="mailto:soporte@khesed-tek-systems.org" className="text-blue-600 underline">soporte@khesed-tek-systems.org</a></p>
            <p>Legal / Refunds: <a href="mailto:legal@khesed-tek-systems.org" className="text-blue-600 underline">legal@khesed-tek-systems.org</a></p>
