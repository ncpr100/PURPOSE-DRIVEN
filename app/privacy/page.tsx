    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 space-y-10 text-gray-700 text-sm leading-relaxed">
        ...
        <section>
          ...
          <p>To exercise any of these rights, contact us at <a href="mailto:legal@khesed-tek-systems.org" className="text-blue-600 underline">legal@khesed-tek-systems.org</a>.</p>
        </section>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-4">10. Cookies and Tracking</h2>
