    ...
    const PRAYER_URGENCY_RULES = [
      {
        ...
        actionsConfig: [
          ...
          { type: 'CREATE_PRAYER_RESPONSE', config: { message: 'Tu petición ha sido recibida. Estamos orando por ti.' } }
        ]
      },
      {
        ...
        actionsConfig: [
          ...
          },
          {
            type: 'SEND_WHATSAPP',
            config: {
              message: '🙏 Hola {{contactName}}, recibimos tu petición de oración (Sección B). Te responderemos en un máximo de 4 horas. Estamos orando por ti.'
            }
          }
        ]
      },
      {
        ...
        actionsConfig: [
          ...
          },
          {
            type: 'SEND_WHATSAPP',
            config: {
              message: '🚨 URGENTE: {{contactName}} necesita oración inmediata (Sección C). Por favor comuníquense con esta persona en los próximos 10 minutos.'
            }
          }
        ]
      }
