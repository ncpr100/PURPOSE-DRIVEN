  ...
  try {
    ...
    if (permanent) {
      ...
      await db.$transaction([
        ...
        db.member_spiritual_profiles.deleteMany({ where: { members: { churchId } } }),
        db.events.deleteMany({ where: { churchId } }),
        db.donations.deleteMany({ where: { churchId } }),
        db.communications.deleteMany({ where: { churchId } }),
        db.automation_executions.deleteMany({ where: { churchId } }),
