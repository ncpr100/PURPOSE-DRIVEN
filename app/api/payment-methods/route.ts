      ...
      if (country === "Colombia") {
        defaults.push(
          {
            name: "Nequi",
            isDigital: true,
            description: "Billetera digital colombiana",
          },
          {
            name: "Daviplata",
            isDigital: true,
        ...
        defaults.push(
          ...
          },
          {
            name: "CoDi",
            isDigital: true,
            description: "Cobro Digital del Banco de México",
          },
        );
        ...
        defaults.push(
          {
            name: "PIX",
            isDigital: true,
            description: "Pago instantáneo del Banco Central de Brasil",
          },
          {
            name: "Boleto Bancário",
            isDigital: false,
            description: "Boleto de pago bancario",
          },
        );
        ...
        defaults.push(
          ...
          },
          {
            name: "Rapipago",
            isDigital: false,
            description: "Pago en puntos Rapipago",
          },
          {
            name: "Pago Fácil",
            isDigital: false,
            description: "Pago en puntos Pago Fácil",
          },
        );
        ...
        defaults.push(
          {
            name: "Khipu",
            isDigital: true,
            description: "Transferencia bancaria Khipu",
          },
          {
            name: "Webpay",
            isDigital: true,
            description: "Pago con tarjeta Transbank/Webpay",
          },
        );
        ...
        defaults.push(
          {
            name: "Yape",
            isDigital: true,
            description: "Billetera digital Yape BCP",
          },
          { name: "Plin", isDigital: true, description: "Pago digital Plin" },
          {
            name: "PagoEfectivo",
            isDigital: false,
            description: "Pago en agentes y bancos",
          },
        );
        ...
        defaults.push(
          {
            name: "Abitab",
            isDigital: false,
            description: "Pago en agencias Abitab",
          },
          {
            name: "RedPagos",
            isDigital: false,
            description: "Pago en puntos RedPagos",
          },
        );
      }
