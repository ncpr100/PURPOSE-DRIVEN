import os
# ═══════════════════════════════════════════════════════════════
# PLANTILLA 3: Agent 2 Crisis Alert (CORREGIDA)
# ═══════════════════════════════════════════════════════════════
agent2_content = '''<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>WhatsApp Next Steps - Agent 2 Crisis Alert Template (ES / EN / PT) | Khesed-Tek Systems</title>
  <style>
...
<body>
  ...
  <h1>WhatsApp Next Steps<br/>Template Submission - Agent 2 Crisis Alert</h1>
  <p class="subtitle">
    <span class="badge">Template 3 of 4</span>
    <span class="badge">Category: Utility</span>
    <span class="badge">Name: agent2_crisis_alert_khesed_tek</span>
    <span class="lang-badge lang-es">ES</span>
    <span class="lang-badge lang-en">EN</span>
    <span class="lang-badge lang-pt">PT</span>
  </p>
  <p>Use this document when filling in the Meta Business Manager template form at <strong>business.facebook.com</strong>. Submit once per language.</p>
  <div class="warning">
    <strong>Important:</strong> Meta does not accept file uploads. You must manually enter each field in Meta Business Manager.<br/><br/>
  ...
  <div id="tab-es" class="tab-panel active">
    <div class="lang-section-header"><span class="lang-badge lang-es">ES</span><h2>Spanish (es) — Español</h2></div>
    <h2>Template Fields</h2>
    <div class="field-block"><div class="field-label">Template Name</div><div class="field-value">agent2_crisis_alert_khesed_tek</div></div>
    ...
    <div class="field-block"><div class="field-label">Header Text (max 60 chars)</div><div class="field-value">Alerta de Crisis — Khesed-Tek</div></div>
    <div class="field-block"><div class="field-label">Body Text</div><div class="field-value">Pastor {{1}},
Se detectó una situación crítica en *{{2}}* que requiere atención inmediata:
*{{3}}*
{{4}}
Por favor, revise el formulario completo en su panel y tome acción pastoral lo antes posible.
Khesed-Tek — Triaje Espiritual</div></div>
    ...
    <div class="field-block"><div class="field-label">Button Type</div><div class="field-value">None (text-only alert)</div></div>
    ...
    <table class="variable-table">
      ...
      <tbody>
        ...
        <tr><td>{{3}}</td><td>crisisType</td><td>Reporte de Violencia Doméstica</td><td>Short title of the crisis</td></tr>
        <tr><td>{{4}}</td><td>crisisDetail</td><td>María López reportó situaciones de violencia en el hogar durante la sesión de consejería del 06/05/2026.</td><td>Full detail of the crisis</td></tr>
      </tbody>
    </table>
    ...
    <div class="step"><span class="step-num">4</span><strong>Template Name:</strong> <code>agent2_crisis_alert_khesed_tek</code></div>
  ...
  <footer>
    ...
    soporte@khesed-tek-systems.org | +57 302 123 4410<br/>
...
with open('templates/agent2-crisis-alert.html', 'w', encoding='utf-8') as f:
    f.write(agent2_content)
print('✅ Plantilla 3 generada: templates/agent2-crisis-alert.html')
# ═══════════════════════════════════════════════════════════════
# PLANTILLA 4: Agent 4 Prayer Reminder (CORREGIDA)
# ═══════════════════════════════════════════════════════════════
agent4_content = '''<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>WhatsApp Next Steps - Agent 4 Prayer Reminder Template (ES / EN / PT) | Khesed-Tek Systems</title>
  <style>
    * { box-sizing: border-box; }
    body { font-family: Arial, sans-serif; max-width: 860px; margin: 40px auto; padding: 0 24px; color: #1a1a2e; }
    h1 { color: #0D1B2E; border-bottom: 3px solid #C9922A; padding-bottom: 10px; }
...
<body>
  ...
  <h1>WhatsApp Next Steps<br/>Template Submission - Agent 4 Prayer Reminder</h1>
  <p class="subtitle">
    <span class="badge">Template 4 of 4</span>
    <span class="badge">Category: Utility</span>
    <span class="badge">Name: agent4_prayer_reminder_khesed_tek</span>
    <span class="lang-badge lang-es">ES</span>
    <span class="lang-badge lang-en">EN</span>
    <span class="lang-badge lang-pt">PT</span>
  </p>
  ...
  <div id="tab-es" class="tab-panel active">
    <div class="lang-section-header"><span class="lang-badge lang-es">ES</span><h2>Spanish (es) — Español</h2></div>
    <h2>Template Fields</h2>
    <div class="field-block"><div class="field-label">Template Name</div><div class="field-value">agent4_prayer_reminder_khesed_tek</div></div>
    <div class="field-block"><div class="field-label">Category</div><div class="field-value">UTILITY</div></div>
    <div class="field-block"><div class="field-label">Language</div><div class="field-value">Spanish (es)</div></div>
    <div class="field-block"><div class="field-label">Header Type</div><div class="field-value">TEXT</div></div>
    <div class="field-block"><div class="field-label">Header Text (max 60 chars)</div><div class="field-value">Recordatorio de Oración — Khesed-Tek</div></div>
    <div class="field-block"><div class="field-label">Body Text</div><div class="field-value">Hola {{1}},
Es momento de orar por:
*{{2}}*
{{3}}
"Orad sin cesar." — 1 Tesalonicenses 5:17
Khesed-Tek — Vigilante de Oración</div></div>
    <div class="field-block"><div class="field-label">Footer Text (max 60 chars)</div><div class="field-value">soporte@khesed-tek-systems.org</div></div>
    <div class="field-block"><div class="field-label">Button Type</div><div class="field-value">None (text-only reminder)</div></div>
    <h2>Variable Reference</h2>
    <table class="variable-table">
      <thead><tr><th>Meta Variable</th><th>System Variable</th><th>Example Value</th><th>Description</th></tr></thead>
      <tbody>
        <tr><td>{{1}}</td><td>adminName</td><td>Pastor Carlos</td><td>Pastor / admin name</td></tr>
        <tr><td>{{2}}</td><td>prayerSubject</td><td>María López — Sanidad Familiar</td><td>Prayer subject</td></tr>
        <tr><td>{{3}}</td><td>prayerDetail</td><td>María solicita oración por la sanidad de su madre enferma. Fecha de petición: 01/05/2026.</td><td>Full prayer detail</td></tr>
      </tbody>
    </table>
    <h2>Step-by-Step Submission</h2>
    <div class="step"><span class="step-num">1</span>Go to <a href="https://business.facebook.com" target="_blank" rel="noopener noreferrer" class="step-link">business.facebook.com</a> → WhatsApp Manager</div>
    <div class="step"><span class="step-num">2</span>Account Tools → Message Templates → Create Template</div>
    <div class="step"><span class="step-num">3</span><strong>Category:</strong> Utility</div>
    <div class="step"><span class="step-num">4</span><strong>Template Name:</strong> <code>agent4_prayer_reminder_khesed_tek</code></div>
    <div class="step"><span class="step-num">5</span><strong>Language:</strong> Spanish (es)</div>
    <div class="step"><span class="step-num">6</span>Header → Text → paste header above</div>
    <div class="step"><span class="step-num">7</span>Body → paste body above</div>
    <div class="step"><span class="step-num">8</span>Footer → paste footer above</div>
...
with open('templates/agent4-prayer-reminder.html', 'w', encoding='utf-8') as f:
    f.write(agent4_content)
print('✅ Plantilla 4 generada: templates/agent4-prayer-reminder.html')
