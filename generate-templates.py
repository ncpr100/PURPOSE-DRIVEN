...
<body>
  ...
  <div id="tab-es" class="tab-panel active">
    ...
    <div class="field-block"><div class="field-label">Header Text (max 60 chars)</div><div class="field-value">Notificación Pastoral — Kh. CMS</div></div>
    <div class="field-block"><div class="field-label">Body Text</div><div class="field-value">Hola, {{1}} de *{{2}}*,
Ha ocurrido un evento que requiere su atención pastoral:
*{{3}}*
{{4}}
Por favor, revise su panel de administración para ver los detalles completos y tomar acción.
...
with open('templates/agent12-cascade.html', 'w', encoding='utf-8') as f:
    f.write(agent12_content)
print('✅ Plantilla 2 generada: templates/agent12-cascade.html')
