...
const AGENTS_STATUS = [
  ...
  {
    name: "Ag.4 Vigilante Oración",
    color: "#26D9D9",
    runs: "En 12 min",
    emoji: "🟡",
  },
  {
    name: "Ag.5 Shepherd Log",
    color: "#F0B83C",
    runs: "4 alertas activas",
    emoji: "🟢",
  },
  {
  ...
  {
    name: "Ag.8 Visitantes",
    color: "#26D9D9",
    runs: "Últ: hace 3 días",
    emoji: "🟢",
  },
  {
    name: "Ag.11 Junta",
            ...
            return (
              ...
              >
                ...
                {"badge" in item && item.badge && (
                  <SidebarBadge
                    count={item.badge}
                    type={item.badgeType as BadgeType}
                  />
                )}
              </div>
            );
